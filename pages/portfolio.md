...
Here are some of my recent long-distance races mapped out natively on the site, compiled onto one map for easy viewing. Their coordinates were extracted from the original Garmin `.fit` files spanning marathons to 5k races, and have been rendered interactively using GPS data processing and Leaflet.js mapping.
